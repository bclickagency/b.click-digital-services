    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4" dir="rtl">
      ...
      >
        <div className="text-center mb-8">
          <span className="text-3xl font-black">B<span className="text-gradient">.</span>CLICK</span>
          <h1 className="text-2xl font-bold mt-4">{isSignUp ? 'إنشاء حساب' : 'لوحة التحكم'}</h1>
          <p className="text-muted-foreground text-sm mt-2">
            {isSignUp ? 'أنشئ حساب جديد' : 'سجّل دخولك للوصول للوحة التحكم'}
          </p>
        </div>
